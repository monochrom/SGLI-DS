...
- Detailfilter mit Chevron: Klick öffnet das Off-Canvas (Hintergrund `color/bg/card`, von rechts, 480 px, auf Phone volle Breite). Gesetzter Wert erscheint als Badge im Chip. Der Chip ist dann geteilt: Klick auf Label oder Badge öffnet das Off-Canvas erneut zum Ändern, Klick auf das X entfernt den Wert (entschieden 2026-09-11).
